...
# MAGIC %fs put dbfs:/tmp/tfrankenberg1@outlook.com.txt "This is a test of the emergency broadcast system, this is only a test" --overwrite=true

# COMMAND ----------

# MAGIC %fs head dbfs:/tmp/tfrankenberg1@outlook.com.txt
...
file_name = "dbfs:/tmp/tfrankenberg1@outlook.com.txt"
